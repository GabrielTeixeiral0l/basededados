...
PROMPT [24/26] Executando Testes de Validação de NOTA (Status, Turma)...
@@teste_validacao_nota.sql

PROMPT [25/26] Executando Teste Integrado (Notas -> Media Geral)...
@@teste_integrado_notas_media.sql

PROMPT [26/27] Executando Testes de Integridade da Tabela PARCELA_PROPINA...
@@testes_tabela_parcela_propina.sql

PROMPT [27/27] Executando Testes de Integridade da Tabela PRESENCA...
@@testes_tabela_presenca.sql
