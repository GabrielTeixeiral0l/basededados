...
BEGIN
    ...
    VALUES ('Estudante Teste Status', TO_DATE('2000-01-01', 'YYYY-MM-DD'), '123456789', '12345678', '912345678', 'est@teste.com', '9')
    ...
    BEGIN
        INSERT INTO estudante (nome, data_nascimento, nif, cc, telemovel, email, status)
        VALUES ('Menor de Idade', ADD_MONTHS(SYSDATE, -17*12), '987654321', '87654321', '911111111', 'jovem@teste.com', '1');
