...
BEGIN
    ...
    VALUES ('Avaliação A', SYSDATE, SYSDATE, 1, 1, v_tur_id, v_tav_id) RETURNING id INTO v_ava_pai_id;

    INSERT INTO avaliacao (titulo, data, data_entrega, peso, max_alunos, turma_id, tipo_avaliacao_id, avaliacao_pai_id)
    VALUES ('F1 (40%)', SYSDATE, SYSDATE, 0.4, 1, v_tur_id, v_tav_id, v_ava_pai_id) RETURNING id INTO v_ava_f1_id;

    INSERT INTO avaliacao (titulo, data, data_entrega, peso, max_alunos, turma_id, tipo_avaliacao_id, avaliacao_pai_id)
    VALUES ('F2 (60%)', SYSDATE, SYSDATE, 0.6, 1, v_tur_id, v_tav_id, v_ava_pai_id) RETURNING id INTO v_ava_f2_id;
    ...
    COMMIT; -- Garante que o trigger processou
    ...
    INSERT INTO avaliacao (titulo, data, data_entrega, peso, max_alunos, turma_id, tipo_avaliacao_id)
    VALUES ('Avaliação B', SYSDATE, SYSDATE, 1, 1, v_tur_id, v_tav_id) RETURNING id INTO v_ava_pai_id;

    INSERT INTO avaliacao (titulo, data, data_entrega, peso, max_alunos, turma_id, tipo_avaliacao_id, avaliacao_pai_id)
    VALUES ('F1 (50%)', SYSDATE, SYSDATE, 0.5, 1, v_tur_id, v_tav_id, v_ava_pai_id) RETURNING id INTO v_ava_f1_id;

    INSERT INTO avaliacao (titulo, data, data_entrega, peso, max_alunos, turma_id, tipo_avaliacao_id, avaliacao_pai_id)
    VALUES ('F2 (50%)', SYSDATE, SYSDATE, 0.5, 1, v_tur_id, v_tav_id, v_ava_pai_id) RETURNING id INTO v_ava_f2_id;
    ...
    IF v_count > 0 THEN
        ...
        IF v_estado_depois = '1' THEN
            DBMS_OUTPUT.PUT_LINE('[OK] Parcela liquidada com sucesso (Estado mudou para 1).');
        ELSE
